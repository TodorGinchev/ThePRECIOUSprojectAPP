...
public class 	CameraFoodRecognition extends Activity {
	    ...
	    try {
	    	if(isExternalStorageWritable()){
	    		 ...
	    		 if(folder.exists() || success){
					 ...
					 f.close();
		             Log.i("tingInExternalFile"+fileName, "Stored "+data);
		             fileSize=(int)file.length();
	    		 }
	    		 else Log.e("tingInExternalFile","unable to create folder or file");
	    	}
	    } catch (Exception e) {
	           Log.e("teStingInExternalFile", e.getMessage(), e);
	    }
	    return fileSize;
	}
...
//	 * TODO
//	 * TODO
//	 * Vamos a ver... o sea, estoy usando substring y indexOf sobre un string super largo un mont�n de veces
//	 * c�mo espero que se ejecute en menos de 100ms? MAAAAAAL
//	 */
...
//	    	    */
	           ...
	           for(int i=0; i<files.length; i++){               
	             ...
	             Log.i("readFileContours","TIME readFileContours"+(System.currentTimeMillis()-timeStamp));
	           }
//	           InputStream input;
	           /*
	            * Read contours
