...
public class confidence_ruler_activity extends AppCompatActivity {


    public static final String TAG = "confidence_ruler_activ";
    public static Context appConext;
    public static final String UI_PREFS_NAME = "UIPreferences";
    private SectionsPagerAdapter mSectionsPagerAdapter;
    private CR_FragmentAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cr_main_activity);
        //If Android version >=5.0, set status bar background color
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(getResources().getColor(R.color.confidenceRuler));
        }
...
//        //setSupportActionBar(toolbar);
        ...
        toolbar.setNavigationIcon(R.drawable.confidence_ruler_back);
        ...
        mAdapter = new CR_FragmentAdapter(getSupportFragmentManager());
