...
public class FirstBeatAlbumImageView extends ImageView {
    ...
    public FirstBeatAlbumImageView(Context context) {
        super(context);
        sharedConstructing(context);
    }

    public FirstBeatAlbumImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        sharedConstructing(context);
    }
