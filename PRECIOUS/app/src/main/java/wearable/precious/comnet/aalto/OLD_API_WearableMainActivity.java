...
public class OLD_API_WearableMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.old_api_wearable_main);
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == menuIndex++) {
                    final ProgressDialog pd = ProgressDialog.show(OLD_API_WearableMainActivity.this, "", "努力运行中, 请稍后......");
