...
public class MainActivity extends Activity {
	...
	private int numAnswers; //number of answered question
	...
	private void showAnswer(){
		...
		//Update score
		for (int i=0;i<4;i++){
			Log.i("My answer",""+answerOrder.get(i));	
			Log.i("Correct answer",""+answerOrder.get(i));	
	...
	private void nextAnswer(){
		...
		if(numAnswers>NUM_QUESTIONS-1){
			...
			//editor1.putBoolean("acelerateSensors", acelerateSensors.isChecked());		//TODO
			editor1.putFloat("aceleration", 0.5f+score/3);
			editor1.putFloat("acelerationMax", -0.5f-score);
			editor1.putFloat("speedMax", 2.0f+score);
			editor1.commit();
