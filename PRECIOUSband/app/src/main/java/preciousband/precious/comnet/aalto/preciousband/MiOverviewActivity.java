package preciousband.precious.comnet.aalto.preciousband;
...
import preciousband.precious.comnet.aalto.preciousband.model.Battery;
import preciousband.precious.comnet.aalto.preciousband.model.LeParams;
import preciousband.precious.comnet.aalto.preciousband.model.MiBand;
import preciousband.precious.comnet.aalto.preciousband.view.ColorPickerDialog;


public class MiOverviewActivity extends Activity implements Observer {
    private static final String TAG = "MiOverviewActivity";
    //HR: http://stackoverflow.com/questions/18699251/finding-out-android-bluetooth-le-gatt-profiles
//    https://android.googlesource.com/platform/development/+/cefd49aae65dc85161d08419494071d74ffb982f/samples/BluetoothLeGatt/src/com/example/bluetooth/le/SampleGattAttributes.java
    ...
    private static final UUID UUID_CHAR_TEST = UUID
            .fromString("0000ff0d-0000-1000-8000-00805f9b34fb");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_leparams:
			if(mMiBand.mLeParams == null) {
                Log.i(TAG, "No LE params received yet");
				return true;
			}
